...
<template>
        ...
        <header class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
            <div id="headwrap">
                ...
                <div id="titlelogo">
                    <a href="">
                        <div id="logo">
                            <img :src="logo" width="167" height="100" alt="Site logo"/>
                ...
                <div id="nwrap">
                    <div id="menuBtn"></div>
                    <nav><ul class="navigation"><li id="current"><a href="/main" id="current1">Main</a></li><li><a href="/contact-us" rel="self">Contact Us</a></li></ul></nav>
                </div>
            </div>
        </header>
    ...
    <div id="container">
        ...
        <section>
            ...
            <div id="padding">
                <div id="extraContainer9"style = "position:relative; top:400px"></div>

                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card card-default">
                            <img id="featureImg" :src="background">
                            <span> Click here to change the background image!</span>
...
<script>
    export default {
        ...
        data: () => ({
            photo: null,
            abc: null,
            background: 'rw_common/images/cda-interview-guide.jpg',
